...
const PhoneDropDownField = ({ handlePhoneField, errors, id, phoneRef }) => {
  ...
  return (
    <div className="w-full flex flex-col lg:gap-y-[0.3125vw] gap-y-[6px]">
      <div className=" cursor-pointer border-[#ffffff4d] border-b lg:h-[6.66666666667vh] sm:h-[62px] h-[45px] flex items-center justify-between">
        <div className="lg:w-[7.808333333vw] lg:min-w-[7.808333333vw] relative min-w-[30%] w-[30%] rtl:border-r ltr:border-r border-[#FFFFFF4D] h-full flex items-center justify-between lg:px-[0.625vw] px-[0px]">
          {/* <input
            type="text"
            value={phoneValue}
        ...
        >
          <input
            ref={phoneRef}
            onChange={(e) =>
              handlePhoneField(selectedOption?.value + e.target.value)
            }
            type="number"
            id="number"
